...
export default function ChronologyPage() {
  ...
  return (
    <>
      ...
      <div
        className={`md:hidden fixed z-50 bg-white shadow-2xl transition-transform duration-300 ease-in-out overflow-y-auto
          bottom-0 left-0 right-0 h-2/3 rounded-t-2xl border-t border-gray-200
