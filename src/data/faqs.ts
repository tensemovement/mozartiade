...
export const faqs: FAQ[] = [
  // 일반
  {
    id: 'general-1',
    category: '일반',
    question: 'Enjoy Mozart는 어떤 서비스인가요?',
    answer: 'Enjoy Mozart는 볼프강 아마데우스 모차르트의 생애와 작품을 종합적으로 탐색할 수 있는 디지털 플랫폼입니다. 626개의 전체 작품 목록, 생애 연대기, 비디오 라이브러리, 퀴즈, 공연 정보, 그리고 굿즈 샵까지 모차르트와 관련된 모든 것을 한 곳에서 만나보실 수 있습니다.',
    order: 1,
  },
  {
    id: 'general-2',
  ...
  },
  {
    ...
    answer: '네, Enjoy Mozart는 반응형 웹 디자인으로 제작되어 PC, 태블릿, 모바일 등 모든 디바이스에서 최적화된 경험을 제공합니다.',
    order: 3,
  },
  {
    id: 'general-4',
